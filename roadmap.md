...
- **READY (DAG-satisfied, mechanical — every dep in {done, resolved}):** {g2, r3, r5, r6,
  ...
  trigger.)
- **NOW (Deep):** ✅ r1 · ✅ r2 · r11 (only live blocker of the headline) · g2 (top of
  lane A, unblocked by r1+r2).
- **NEXT (Deep, directional):** g1 (the moment r11 lands) · g3 (←g2+r11) · r3 · r4 (←r3) · r13 ·
  r14 (←r11).
